...
setup(
    ...
    scripts=[
        ...
        "bb_filters/nodes/cluster/cluster_poses_action_node_nw.py",
        "bb_filters/nodes/cluster/cluster_poses_node.py",
        "bb_filters/nodes/cluster/cluster_poses_node_nw.py",
        "bb_filters/nodes/cluster/cluster_poses_service_node.py",
        "bb_filters/nodes/cluster/cluster_poses_service_node_nw.py",
